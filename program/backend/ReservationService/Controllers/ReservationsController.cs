...
[Authorize]
public class ReservationsController(IReservationRepository repository, IHotelRepository hotelRepository, IMapper mapper, ITokenService tokenService, ILogger<ReservationsController> logger) : Controller
{
